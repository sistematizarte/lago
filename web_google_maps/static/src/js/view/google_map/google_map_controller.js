odoo.define('web_google_maps.GoogleMapController', function (require) {
    ...
    var lat = 10.400226364886393;
    var lon = -66.84799783800233;
    var interval;
...
//////////////////////////////////////////////////
                this.$buttons.on(
                    'click',
                    'button.o-map-button-play-map',
                    this._onButtonMapCenter2.bind(this)
                );

                this.$buttons.on(
                    'click',
                    'button.o-map-button-stop-map',
                    this._onButtonMapCenterStop.bind(this)
                );
                //////////////////////////////////////////////////
                this.$buttons.on(
                    'click',
        ...
        _draw: function () {
            	let query = '<div style="width: 100%"><iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=es&amp;q=' + lat + ',' + lon + '+(Aqui)&amp;t=&amp;z=18&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://www.mapsdirections.info/marcar-radio-circulo-mapa/">Dibujar radio en el mapa</a></div>';
        	console.log(query);
            	document.getElementsByClassName('o_content')[0].innerHTML = query;
            	lat += 0.0011199;
        },
        _onButtonMapCenter2: function (event) {
...
//            setInterval(draw, 10000);
            this._draw();
            interval = setInterval(this._draw, 10000);


        },
        _onButtonMapCenterStop: function (event) {
